...
Options:
  ...
  --default-duration <seconds>  Default duration per slide (default: 4)
...
async function main() {
  ...
  if (config.output === 'separate') {
    const lang1File = `${config.outputBase}.${config.lang1}.srt`;
    const lang2File = `${config.outputBase}.${config.lang2}.srt`;
    ...
    const bilingualFile = `${config.outputBase}.srt`;
